...
| [voice-over-datachannels.md](voice-over-datachannels.md) | You touch voice: Opus frames on unreliable data channels, the jitter buffer, SFU routing without renegotiation, or the capture/playout gotchas on macOS. |
