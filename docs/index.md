...
| [video.md](video.md) | You send or watch video - a screen, a camera, an arcade cabinet: how H.264 rides a media stream, the encode and decode pipelines, the bitrate loop, and how to run `screendemo`. |
