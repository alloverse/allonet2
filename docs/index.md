...
| [assets.md](assets.md) | You touch anything that publishes, fetches or names an asset — or the place's HTTP server (FlyingFox has teeth) — or render a fetched mesh. |
