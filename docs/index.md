...
Deep notes that aren't easily rediscovered from the code live here — architecture,
...
- [assets.md](assets.md) — content-addressed assets over HTTP: store layout, FlyingFox pitfalls, Linux constraints, and how a mesh asset becomes a RealityKit visual.
